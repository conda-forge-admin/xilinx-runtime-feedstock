...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xilinx-runtime-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xilinx-runtime-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add xilinx-runtime
# for installing globally
pixi global install xilinx-runtime
```
...
It is possible to list all of the versions of `xilinx-runtime` available on your platform:
...
```
pixi search xilinx-runtime --channel conda-forge
```
